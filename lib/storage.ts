...
export class MemStorage implements IStorage {
  ...
  private simulateOrderProgress(order: Order): Order {
    ...
    if (updated.status === "picked_up") {
      ...
      const address = order.addressId ? this.addresses.get(String(order.addressId)) : null;
      ...
      if (restaurant && address && restaurant.latitude && restaurant.longitude && address.latitude && address.longitude) {
        ...
        const prev = order.deliveryPartnerLocation;
  ...
  private seedData() {
    ...
    const restaurants: Restaurant[] = [
      {
        ...
        imageUrl: "https://plus.unsplash.com/premium_photo-1661419883163-bb4df1c10109?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        coverImageUrl: "https://plus.unsplash.com/premium_photo-1661419883163-bb4df1c10109?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        address: "Sector 17, Vashi, Navi Mumbai, Maharashtra",
        latitude: "19.0760",
        longitude: "72.9986",
        phone: "+91 1234567890",
        email: "tandoori@Gourmet.com",
        rating: "4.5",
        reviewCount: 324,
        priceRange: 2,
        deliveryTime: 35,
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1655471264223-b07ce84d521c?q=80&w=811&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        coverImageUrl: "https://images.unsplash.com/photo-1655471264223-b07ce84d521c?q=80&w=811&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        address: "Sector 7, Nerul, Navi Mumbai, Maharashtra",
        latitude: "19.0330",
        longitude: "73.0176",
        phone: "+91 1234567890",
        email: "pizza@Gourmet.com",
        rating: "4.3",
        reviewCount: 512,
        priceRange: 3,
        deliveryTime: 30,
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1559847844-5315695dadae?q=80&w=1158&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        coverImageUrl: "https://images.unsplash.com/photo-1559847844-5315695dadae?q=80&w=1158&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        address: "Sector 35, Kharghar, Navi Mumbai, Maharashtra",
        latitude: "19.0469",
        longitude: "73.0698",
        phone: "+91 1234567890",
        email: "dragon@Gourmet.com",
        rating: "4.2",
        reviewCount: 289,
        priceRange: 2,
        deliveryTime: 40,
      ...
      },
      {
        ...
        address: "Sector 20, Airoli, Navi Mumbai, Maharashtra",
        latitude: "19.1590",
        longitude: "72.9985",
        phone: "+91 1234567890",
        email: "green@Gourmet.com",
        rating: "4.6",
        reviewCount: 178,
        priceRange: 3,
        deliveryTime: 25,
      ...
      },
      {
        ...
        coverImageUrl: "https://images.unsplash.com/photo-1572802419224-296b0aeee0d9?q=80&w=1115&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        address: "Sector 5, Ghansoli, Navi Mumbai, Maharashtra",
        latitude: "19.1258",
        longitude: "73.0127",
        phone: "+91 1234567890",
        email: "burger@Gourmet.com",
        rating: "4.1",
        reviewCount: 445,
        priceRange: 2,
        deliveryTime: 20,
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1643268972535-a2b100ff3632?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        coverImageUrl: "https://images.unsplash.com/photo-1643268972535-a2b100ff3632?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        address: "Sector 11, Kopar Khairane, Navi Mumbai, Maharashtra",
        latitude: "19.1031",
        longitude: "73.0077",
        phone: "+91 1234567890",
        email: "dosa@Gourmet.com",
        rating: "4.4",
        reviewCount: 623,
        priceRange: 1,
        deliveryTime: 25,
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1697276063790-a68a966b12f7?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        coverImageUrl: "https://images.unsplash.com/photo-1697276063790-a68a966b12f7?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        address: "Sector 11, Kopar Khairane, Navi Mumbai, Maharashtra",
        latitude: "19.1031",
        longitude: "73.0077",
        phone: "+91 1234567890",
        email: "royalbiryani@Gourmet.com",
        rating: "4.7",
        reviewCount: 890,
        priceRange: 2,
        deliveryTime: 45,
      ...
      },
      {
        ...
        imageUrl: "https://plus.unsplash.com/premium_photo-1678198828975-02016abf2c5e?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        coverImageUrl: "https://plus.unsplash.com/premium_photo-1678198828975-02016abf2c5e?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        address: "Sector 19, Ulwe, Navi Mumbai, Maharashtra",
        latitude: "18.9750",
        longitude: "73.0256",
        phone: "+91 1234567890",
        email: "sweets@Gourmet.com",
        rating: "4.8",
        reviewCount: 412,
        priceRange: 2,
        deliveryTime: 20,
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1611270629569-8b357cb88da9?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        coverImageUrl: "https://images.unsplash.com/photo-1611270629569-8b357cb88da9?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        address: "Sector 19, Ulwe, Navi Mumbai, Maharashtra",
        latitude: "18.9750",
        longitude: "73.0256",
        phone: "+91 1234567890",
        email: "pasta@Gourmet.com",
        rating: "4.5",
        reviewCount: 220,
        priceRange: 3,
        deliveryTime: 35,
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1633478062482-790e3b5dd810?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        coverImageUrl: "https://images.unsplash.com/photo-1633478062482-790e3b5dd810?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        address: "Sector 19, Ulwe, Navi Mumbai, Maharashtra",
        latitude: "18.9750",
        longitude: "73.0256",
        phone: "+91 1234567890",
        email: "sushi@Gourmet.com",
        rating: "4.9",
        reviewCount: 560,
        priceRange: 4,
        deliveryTime: 45,
      ...
      },
      {
        ...
        imageUrl: "https://images.unsplash.com/photo-1627564803215-ad55bad5c5ea?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        ...
        address: "Sector 4, CBD Belapur, Navi Mumbai, Maharashtra",
        latitude: "19.0234",
        longitude: "73.0400",
        phone: "+91 1234567890",
        email: "taco@Gourmet.com",
        rating: "4.2",
        reviewCount: 180,
        priceRange: 2,
        deliveryTime: 25,
      ...
      },
      {
        ...
        imageUrl: "https://plus.unsplash.com/premium_photo-1694699354443-289006ee7362?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        coverImageUrl: "https://plus.unsplash.com/premium_photo-1694699354443-289006ee7362?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
        address: "Sector 4, CBD Belapur, Navi Mumbai, Maharashtra",
        latitude: "19.0234",
        longitude: "73.0400",
        phone: "+91 1234567890",
        email: "curry@Gourmet.com",
        rating: "4.4",
        reviewCount: 310,
        priceRange: 2,
        deliveryTime: 35,
    ...
    const dishes: Dish[] = [
      ...
      { id: "d2-4", restaurantId: "rest-2", categoryId: "cat-5", name: "BBQ Chicken", description: "Smoky Chicken", imageUrl: "https://images.unsplash.com/photo-1655471264223-b07ce84d521c?q=80&w=811&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", price: "429", isVeg: false, isAvailable: true, rating: "4.7", reviewCount: 210, isBestseller: true, isNew: false, isChefSpecial: true, isHealthy: false, spiceLevel: 2, portionSize: "Medium", preparationTime: 20, customizations: null },
      ...
      // --- Rest 3: Thai Dragon ---
      { id: "d3-1", restaurantId: "rest-3", categoryId: "cat-8", name: "Veg Hakka Noodles", description: "Classic stir fry", imageUrl: "https://images.unsplash.com/photo-1569718212165-3a8278d5f624?q=80&w=880&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", price: "199", isVeg: true, isAvailable: true, rating: "4.3", reviewCount: 100, isBestseller: true, isNew: false, isChefSpecial: false, isHealthy: false, spiceLevel: 1, portionSize: "Regular", preparationTime: 15, customizations: null },
      ...
      // --- Rest 7: Royal Biryani ---
      { id: "d7-1", restaurantId: "rest-7", categoryId: "cat-20", name: "Chicken Hyderabadi", description: "Authentic dum", imageUrl: "https://images.unsplash.com/photo-1697276063790-a68a966b12f7?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", price: "299", isVeg: false, isAvailable: true, rating: "4.8", reviewCount: 500, isBestseller: true, isNew: false, isChefSpecial: true, isHealthy: false, spiceLevel: 3, portionSize: "Serves 1", preparationTime: 25, customizations: null },
      ...
      { id: "d7-8", restaurantId: "rest-7", categoryId: "cat-21", name: "Chicken Lucknowi", description: "Rich aroma", imageUrl: "https://images.unsplash.com/photo-1697276063790-a68a966b12f7?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", price: "319", isVeg: false, isAvailable: true, rating: "4.7", reviewCount: 160, isBestseller: false, isNew: false, isChefSpecial: true, isHealthy: false, spiceLevel: 1, portionSize: "Serves 1", preparationTime: 30, customizations: null },
      ...
      { id: "d7-10", restaurantId: "rest-7", categoryId: "cat-20", name: "Family Pack", description: "Chicken (Serves 4)", imageUrl: "https://images.unsplash.com/photo-1697276063790-a68a966b12f7?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", price: "999", isVeg: false, isAvailable: true, rating: "4.9", reviewCount: 100, isBestseller: true, isNew: false, isChefSpecial: false, isHealthy: false, spiceLevel: 2, portionSize: "Family", preparationTime: 40, customizations: null },

      // --- Rest 8: Midnight Cravings ---
      ...
      // --- Rest 12: Curry Corner (North Indian) ---
