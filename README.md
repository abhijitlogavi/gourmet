# <img src="public/logo.svg" alt="Gourmet Logo" width="45" height="45" align="top" /> Gourmet

Gourmet is a modern, feature-rich food delivery web application built with **Next.js 15 (App Router)**. It provides a seamless experience for browsing restaurants, managing a cart, and tracking orders in real-time.

**Live Demo:** [https://Gourmet-three-sigma.vercel.app](https://Gourmet-three-sigma.vercel.app)
...
* **AI Assistant:** Integrated **Gourmet AI** (powered by Google Gemini) to answer queries about food, calories, and diet.
...
1.  **Clone the repository:**
    ```bash
    git clone [https://github.com/Anexus5919/Gourmet.git](https://github.com/Anexus5919/Gourmet.git)
    cd Gourmet
    ```
