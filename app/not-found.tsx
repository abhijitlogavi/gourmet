  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[85vh] text-center px-4 space-y-8 animate-in fade-in zoom-in duration-500">
      ...
      <div className="relative">
        ...
        <div className="relative bg-blue-100 dark:bg-blue-900/20 p-8 rounded-full">
          <UtensilsCrossed className="h-20 w-20 text-blue-500" />
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 min-w-[300px] justify-center">
        <Button asChild size="lg" className="bg-blue-500 hover:bg-blue-600 text-white shadow-lg shadow-blue-500/25">
          <Link href="/">
