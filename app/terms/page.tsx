        ...
        <div className="prose dark:prose-invert max-w-none space-y-8 text-justify leading-relaxed">
          <section>
            ...
            <p className="text-muted-foreground">
              Welcome to <strong>Gourmet</strong> (&ldquo;Company&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;, &ldquo;us&rdquo;). These Terms and Conditions (&ldquo;Terms&rdquo;, &ldquo;Terms and Conditions&rdquo;) govern your use of our website and mobile application (collectively, the &ldquo;Service&rdquo;) operated by Gourmet. By accessing or using the Service, you agree to be bound by these Terms. If you disagree with any part of the terms, then you may not access the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-muted-foreground">
              <li><strong>Service:</strong> Refers to the Gourmet website and mobile application.</li>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              The Service and its original content (excluding Content provided by users and restaurants), features, and functionality are and will remain the exclusive property of Gourmet and its licensors. The Service is protected by copyright, trademark, and other laws of India and foreign countries.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-none mt-2 space-y-1 text-muted-foreground">
              <li>By email: <strong>legal@Gourmet.com</strong></li>
              <li>By phone: +91 1234567890</li>
              <li>By mail: Navi Mumbai, Maharashtra, India</li>
            </ul>
          </section>
        </div>
      </div>
