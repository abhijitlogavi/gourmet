...
export default function PartnerPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <h1 className="text-4xl font-bold mb-6">Partner with Gourmet</h1>
      <p className="text-xl text-muted-foreground mb-8">
        Grow your business with us. Reach new customers and increase your sales by listing your restaurant on Gourmet.
      </p>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-12">
        ...
        <div className="p-6 border rounded-lg bg-card hover:shadow-md transition-shadow">
          <ChefHat className="h-10 w-10 text-blue-500 mb-4" />
        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DialogContent className="sm:max-w-[500px] max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Fill in the details below to list your restaurant on Gourmet.
              </DialogDescription>
            </DialogHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 pt-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="ownerName" placeholder="Abhijit Logavi" required />
                </div>
                <div className="space-y-2">
