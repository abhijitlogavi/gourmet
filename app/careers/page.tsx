...
export default function CareersPage() {
  const handleDropCV = () => {
    window.location.href = "mailto:careers@Gourmet.com?subject=Job Application - [Your Name]";
  };

  return (
    <div className="container mx-auto px-4 py-16 max-w-4xl">
      <h1 className="text-4xl font-bold mb-6">Careers at Gourmet</h1>
      ...
      <div className="flex flex-col items-center justify-center p-12 border-2 border-dashed border-muted-foreground/20 rounded-xl bg-muted/10">
        ...
        <p className="text-xs text-muted-foreground mt-2">
          Send your resume to careers@Gourmet.com
        </p>
      </div>
    </div>
  );
