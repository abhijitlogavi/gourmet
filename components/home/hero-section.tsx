...
const heroImage = "/HeroCover.png";


const trustStats = [
  { icon: Star, value: "4.8", label: "User Rating" },
  { icon: Clock, value: "25 mins", label: "Avg Delivery Time" },
...
export function HeroSection() {
  ...
  return (
    ...
    <section
      className="relative h-auto flex items-center pb-20"
    ...
    >
      ...
      <div className="w-full px-4 md:px-20 relative z-10">
        <div className="max-w-2xl pt-24">
          {/* Main Heading */}
          <h1 className="text-4xl md:text-5xl lg:text-4xl font-bold text-white mb-6 leading-tight tracking-tight">
            Crafted for Cravings.<br />
            <span className="text-blue-500">Powered by Gourmet.</span>
          </h1>

          <p className="text-xl text-gray-300 mb-8 max-w-lg font-medium">
            Craving something? Order from your favorite restaurants and get it delivered fast.
          </p>
          ...
          >
            ...
            <Button
              type="submit"
              size="lg"
              className="h-12 px-8 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg"
            >
              Search
            </Button>
          </form>
